...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/iamrkay786/VILLAIN-MUSIC",)
...
AUTO_LEAVE_ASSISTANT_TIME = int(getenv("ASSISTANT_LEAVE_TIME", "120"))
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/gcauas.jpg")
