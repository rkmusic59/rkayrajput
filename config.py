...
BOT_USERNAME = getenv("BOT_USERNAME" , "SUCHI_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME" , "SUCHI")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/legendtosif/SUCHI-MUSIC",)
